#' Winsorize Whole Sample
#'
#' This function winsorizes the specified column in the entire dataset.
#'
...
# Function to winsorize whole sample
winsor <- function(data, value_col, bounds = c(0.05, 0.95)) {
  new_col_name <- paste0(value_col, "_w")
  data <<- data %>%
    mutate(
